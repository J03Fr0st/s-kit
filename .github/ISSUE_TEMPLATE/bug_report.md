...
## Is this a s-kit issue or a platform issue?
<!-- s-kit is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without s-kit installed.

     If the problem persists without s-kit, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without s-kit installed
