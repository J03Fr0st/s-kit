...
claude -p "I have a plan at docs/specs/2026-05-27-auth-system/README.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
