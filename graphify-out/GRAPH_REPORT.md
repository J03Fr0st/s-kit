# Graph Report - s-kit  (2026-06-16)

## Corpus Check
- 209 files · ~139,603 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2262 nodes · 2197 edges · 232 communities (189 shown, 43 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe19e78a`
...
Cohesion: 0.07
Nodes (27): author, name, url, description, homepage, hooks, interface, brandColor (+19 more)
...
Cohesion: 0.12
Nodes (15): agents, author, email, name, commands, description, displayName, homepage (+7 more)
...
Cohesion: 0.13
Nodes (14): Alternatives Considered, Approved Approach, Architecture, Candidate 1: Reviewer Read-Only Safety and Scoped Git Ranges, Candidate 2: Codex Native Hook Support, Candidate 3: Action-Language Skill Prose, Candidate 4: Porting-to-New-Harness Playbook, Candidate 5: Evaluation Harness Strategy (+6 more)
...
Cohesion: 0.12
Nodes (15): Critical Rules, Instructions, Optional: Map Existing Patterns First, Plan Feature, Step 1: Verify Approved Design, Step 2: Derive the Spec Folder, Step 3: Decompose into Tasks, Step 4: Build the Dependency Graph (+7 more)
...
Cohesion: 0.12
Nodes (15): main, name, scripts, doctor, smoke, test, test:brainstorm-server, verify:agents (+7 more)

### Community 36 - "Community 36"
Cohesion: 0.15
Nodes (12): 1. Harness Discovery, 2. Install Mechanism, 3. Skill Discovery and Invocation, 4. Bootstrap and Session Start, 5. Tool Mapping, 6. Acceptance Tests, 7. Local Install Verification, 8. Distribution and Release Checks (+4 more)

### Community 37 - "Community 37"
Cohesion: 0.17
Nodes (11): Behavior Tests Are Eval Candidates, Classification Rules, Coverage Map Requirement, Current Test Categories, Decision Posture, Eval Harness Strategy, First Eval Spike, Integration Tests May Stay Optional (+3 more)

### Community 38 - "Community 38"
Cohesion: 0.17
Nodes (11): Does this PR contain multiple unrelated changes?, Environment tested, Evaluation, Existing PRs, Human review, Is this change appropriate for the core library?, New harness support (required if this PR adds a new harness), Rigor (+3 more)
...
Cohesion: 0.13
Nodes (14): actionRequiredPath, allowedTaskStatuses, created, designPath, feature, implementationLogPath, requirementsPath, runState (+6 more)
...
Cohesion: 0.22
Nodes (8): Agents, Attribution, Install Targets, License, s-kit, Skills, Verification, Workflow
...
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Assumptions, Goals, Non-Goals, Requirements: Superpowers Dev Port Review, Summary, Technical Constraints
...
Cohesion: 0.25
Nodes (7): ADR Threshold, Documentation Sources, Grill With Docs, Handoff, Language Rules, Session Loop, When to Use

### Community 63 - "Community 63"
Cohesion: 0.25
Nodes (7): Actual behavior, Debug log or conversation transcript, Environment, Expected behavior, Is this a s-kit issue or a platform issue?, Steps to reproduce, What happened?

### Community 64 - "Community 64"
Cohesion: 0.36
Nodes (5): Add-Failure(), Join-RepoPath(), Read-JsonFile(), Test-PackageScript(), Test-RequiredPath()
...
Cohesion: 0.29
Nodes (6): Inputs, Output, Process, Rules, s-kit Coder, Status Values

### Community 67 - "Community 67"
Cohesion: 0.29
Nodes (6): Inputs, Output, Rules, s-kit Security Auditor, Use When, What To Check
...
Cohesion: 0.67
Nodes (6): Add-Failure(), Join-RepoPath(), Require-Contains(), Require-File(), Require-MissingPath(), Require-NotContains()

### Community 73 - "Community 73"
Cohesion: 0.33
Nodes (5): Inputs, Output, Process, Rules, s-kit Code Simplifier

### Community 74 - "Community 74"
Cohesion: 0.33
Nodes (5): Inputs, Output, Process, Rules, s-kit Codebase Mapper

### Community 75 - "Community 75"
Cohesion: 0.33
Nodes (5): Inputs, Output, Process, Rules, s-kit Fixer

### Community 76 - "Community 76"
Cohesion: 0.33
Nodes (5): Inputs, Output, Process, Rules, s-kit Pattern Mapper
...
Cohesion: 0.33
Nodes (5): Context, Is this appropriate for core s-kit?, Proposed solution, What alternatives did you consider?, What problem does this solve?
...
Cohesion: 0.33
Nodes (5): Action Required Template, Common Manual Steps, Key Points, Template (when manual steps exist), Template (when no manual steps exist)
...
Cohesion: 0.40
Nodes (4): Action Required: Superpowers Dev Port Review, After Implementation, Before Implementation, During Implementation

### Community 87 - "Community 87"
Cohesion: 0.40
Nodes (4): Brainstorming Ideas Into Designs, Checklist, Process, Visual Companion
...
Cohesion: 0.40
Nodes (4): ADR Format, Minimal Template, Optional Sections, When to Write One

### Community 90 - "Community 90"
Cohesion: 0.50
Nodes (3): __dirname, normalizePath(), SKitPlugin()
...
Cohesion: 0.50
Nodes (3): CONTEXT.md Format, Rules, Single vs Multiple Contexts
...
Cohesion: 0.50
Nodes (3): Does this tool have a plugin or extension system?, Have you tried manual installation?, Which IDE or platform?

### Community 103 - "Community 103"
Cohesion: 0.50
Nodes (3): Coder Agent Prompt Template, Placeholder Details, Template
...
Cohesion: 0.50
Nodes (3): Design Template, Key Points, Template

### Community 106 - "Community 106"
Cohesion: 0.50
Nodes (3): Fix Agent Prompt Template, Placeholder Details, Template

### Community 107 - "Community 107"
Cohesion: 0.50
Nodes (3): Key Points, README Template, Template

### Community 108 - "Community 108"
Cohesion: 0.50
Nodes (3): Key Points, Requirements Template, Template

### Community 109 - "Community 109"
Cohesion: 0.50
Nodes (3): Placeholder Details, Review Agent Prompt Template, Template

### Community 110 - "Community 110"
Cohesion: 0.50
Nodes (3): Placeholder Details, Simplifier Agent Prompt Template, Template

### Community 111 - "Community 111"
Cohesion: 0.50
Nodes (3): Key Points, Task File Template, Template
...
Cohesion: 0.50
Nodes (3): Answer, Q: Why does Writing Skills connect so many communities?, Source Nodes
...
Cohesion: 0.14
Nodes (13): Alternatives Considered, Approved Approach, Architecture, Configuration and Inputs, Context, Decisions, Design: Workflow Optimization Bundle, Risks and Constraints (+5 more)
...
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Assumptions, Goals, Non-Goals, Requirements: Workflow Optimization Bundle, Summary, Technical Constraints

### Community 185 - "Community 185"
Cohesion: 0.25
Nodes (7): Analyze Changes, Categorize Changes, Choose Format, Create or Update the PR, PR Description, Quality Bar, Title

### Community 186 - "Community 186"
Cohesion: 0.39
Nodes (6): Add-Failure(), Get-ClaudeInvocations(), Get-CursorInvocations(), Get-NormalizedHookCommand(), Join-RepoPath(), Read-JsonFile()

### Community 189 - "Community 189"
Cohesion: 0.18
Nodes (10): API and Structured Output, GitHub Actions, GitHub CLI Reference, Issues, Projects, Secrets, and Variables, Releases, Repositories, Authentication (+2 more)

### Community 190 - "Community 190"
Cohesion: 0.17
Nodes (11): Azure DevOps CLI Reference, Builds, Extension Setup, Output and Queries, Pipelines, Repositories and Policies, Variables and Variable Groups, Work Items (+3 more)

### Community 191 - "Community 191"
Cohesion: 0.29
Nodes (6): Azure DevOps CLI, Common Workflows, Detection, Output Rules, Prerequisites, Safety

### Community 192 - "Community 192"
Cohesion: 0.33
Nodes (5): Common Workflows, GitHub CLI, Output Rules, Prerequisites, Safety
...
Cohesion: 0.15
Nodes (12): Alternatives Considered, Approved Approach, Architecture, Configuration and Inputs, Context, Decisions, Design: Ship It Delivery Skill, File Changes (+4 more)
...
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Assumptions, Goals, Non-Goals, Requirements: Ship It Delivery Skill, Summary, Technical Constraints
...
Cohesion: 0.18
Nodes (10): Dependency Graph, Overview, Quick Links, Task Status, Wave 1, Wave 2, Wave 3, Wave 4 (+2 more)

### Community 226 - "Community 226"
Cohesion: 0.20
Nodes (9): Alternatives Considered, Approved Approach, Architecture, Configuration and Inputs, Context, Decisions, Design: Workflow Lessons Hardening, Risks and Constraints (+1 more)

### Community 227 - "Community 227"
Cohesion: 0.25
Nodes (7): 2026-06-16 - Baseline Verification, 2026-06-16 - Design Approved, 2026-06-16 - Implementation Completed, 2026-06-16 - Spec Created, 2026-06-16 - Verification Blockers Resolved, 2026-06-16 - Verification Evidence, Implementation Log: Workflow Lessons Hardening

### Community 228 - "Community 228"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Assumptions, Goals, Non-Goals, Requirements: Workflow Lessons Hardening, Summary, Technical Constraints

### Community 229 - "Community 229"
Cohesion: 0.40
Nodes (4): Agent Doc Writing Quality, Checklist, Non-Goals, Review Questions

### Community 230 - "Community 230"
Cohesion: 0.40
Nodes (4): Commands, Related Playbooks, Rules, Smoke Checks

## Knowledge Gaps
- **1540 isolated node(s):** `name`, `description`, `name`, `email`, `plugins` (+1535 more)
